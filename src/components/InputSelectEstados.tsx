...
import Props, { PropsMunicipios } from "../assets/InterfacesProps";
...
export const InputSelectEstados = ({ handle, value, name }: Props) => {
  const options = Object.keys(estados).map((estado) => ({
    label: estado,
    id: estado,
    value: estado,
    estado: estado,
  ...
  const change = (e: object) => {
    handle && handle({ target: { name, value: e } });
  };
...
export const InputSelectMunicipio = ({
  name,
  placeholder,
  handle,
  value,
